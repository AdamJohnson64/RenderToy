...
namespace RenderToy
{
	...
	public enum struct D3DSrvDimension
	{
		...
		D3D10Unknown = D3D10_SRV_DIMENSION_UNKNOWN,
		D3D10Buffer = D3D10_SRV_DIMENSION_BUFFER,
		D3D10Texture1D = D3D10_SRV_DIMENSION_TEXTURE1D,
		D3D10Texture1DArray = D3D10_SRV_DIMENSION_TEXTURE1DARRAY,
		D3D10Texture2D = D3D10_SRV_DIMENSION_TEXTURE2D,
		D3D10Texture2DArray = D3D10_SRV_DIMENSION_TEXTURE2DARRAY,
		D3D10Texture2DMs = D3D10_SRV_DIMENSION_TEXTURE2DMS,
		D3D10Texture2DMsArray = D3D10_SRV_DIMENSION_TEXTURE2DMSARRAY,
		D3D10Texture3D = D3D10_SRV_DIMENSION_TEXTURE3D,
		D3D10TextureCube = D3D10_SRV_DIMENSION_TEXTURECUBE,
		D3D10p1Unknown = D3D10_1_SRV_DIMENSION_UNKNOWN,
		D3D10p1Buffer = D3D10_1_SRV_DIMENSION_BUFFER,
		D3D10p1Texture1D = D3D10_1_SRV_DIMENSION_TEXTURE1D,
		D3D10p1Texture1DArray = D3D10_1_SRV_DIMENSION_TEXTURE1DARRAY,
		D3D10p1Texture2D = D3D10_1_SRV_DIMENSION_TEXTURE2D,
		D3D10p1Texture2DArray = D3D10_1_SRV_DIMENSION_TEXTURE2DARRAY,
		D3D10p1Texture2DMs = D3D10_1_SRV_DIMENSION_TEXTURE2DMS,
		D3D10p1Texture2DMsArray = D3D10_1_SRV_DIMENSION_TEXTURE2DMSARRAY,
		D3D10p1Texture3D = D3D10_1_SRV_DIMENSION_TEXTURE3D,
		D3D10p1TextureCube = D3D10_1_SRV_DIMENSION_TEXTURECUBE,
		D3D10p1TextureCubeArray = D3D10_1_SRV_DIMENSION_TEXTURECUBEARRAY,
		D3D11Unknown = D3D11_SRV_DIMENSION_UNKNOWN,
		D3D11Buffer = D3D11_SRV_DIMENSION_BUFFER,
		D3D11Texture1D = D3D11_SRV_DIMENSION_TEXTURE1D,
		D3D11Texture1DArray = D3D11_SRV_DIMENSION_TEXTURE1DARRAY,
		D3D11Texture2D = D3D11_SRV_DIMENSION_TEXTURE2D,
		D3D11Texture2DArray = D3D11_SRV_DIMENSION_TEXTURE2DARRAY,
		D3D11Texture2DMs = D3D11_SRV_DIMENSION_TEXTURE2DMS,
		D3D11Texture2DMsArray = D3D11_SRV_DIMENSION_TEXTURE2DMSARRAY,
		D3D11Texture3D = D3D11_SRV_DIMENSION_TEXTURE3D,
		D3D11TextureCube = D3D11_SRV_DIMENSION_TEXTURECUBE,
		D3D11TextureCubeArray = D3D11_SRV_DIMENSION_TEXTURECUBEARRAY,
		D3D11BufferEx = D3D11_SRV_DIMENSION_BUFFEREX,
	};
