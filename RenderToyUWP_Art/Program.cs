...
namespace RenderToy
{
    class Program
    {
        ...
        static IScene DefaultScene
        {
            get
            {
                var scene = new Scene();
                scene.children.Add(new Node("Plane (Ground)", new TransformMatrix(MathHelp.CreateMatrixIdentity()), new Plane(), StockMaterials.DarkGray, new Checkerboard()));
                scene.children.Add(new Node("Sphere (Red)", new TransformMatrix(MathHelp.CreateMatrixTranslate(-2, 1, 0)), new Sphere(), StockMaterials.Red, StockMaterials.PlasticRed));
                scene.children.Add(new Node("Sphere (Green)", new TransformMatrix(MathHelp.CreateMatrixTranslate(0, 1, 0)), new Sphere(), StockMaterials.Green, StockMaterials.PlasticGreen));
                scene.children.Add(new Node("Sphere (Blue)", new TransformMatrix(MathHelp.CreateMatrixTranslate(+2, 1, 0)), new Sphere(), StockMaterials.Blue, StockMaterials.PlasticBlue));
                scene.children.Add(new Node("Sphere (Glass)", new TransformMatrix(MathHelp.CreateMatrixTranslate(0, 1, -2)), new Sphere(), StockMaterials.Black, StockMaterials.Glass));
                return scene;
            }
        }
